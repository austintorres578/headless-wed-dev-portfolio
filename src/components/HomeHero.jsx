        ...
        <section className="home-hero">
            <div className="site-container">
                <div className="hero-content">
                    <span className="pretext">Freelance Web Developer · NJ</span>
                    <h1>
                    ...
                    <div className="button-flex">
                        <Link to="/work" className="orange-button">See My Work</Link>
                        <Link to="/contact" className="transparent-button">Start A Project</Link>
                ...
                <div className="hero-austin">
                    <img src="#" alt="Austin Torres" />
                </div>
            </div>
        </section>
    )
